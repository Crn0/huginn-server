...
export const userTweetsPaginationSchema = paginationSchema.extend({ data: userTweetsSchema });

export const userTweetMediaPaginationSchema = paginationSchema.extend({
  media: z.array(tweetMedia),
});
